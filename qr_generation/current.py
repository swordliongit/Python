...
for i in range(2000, 3001):
    ...
    x_pos += (
        QR_SIZE + SPACING - 15
    )  # Change this constant at the end to determine the space between each qr code side by side
    ...
    if qr_counter % COLS == 0:
        ...
        y_pos += (
            QR_SIZE + SPACING + 15
        )  # Change this constant to have space between the label and the next row of qr codes
